            ...
            <div class="relative" x-data="{ dropdownOpen: false }">
                ...
                <div
                    ...
                    <div class="px-4.5 py-3">
                        <h5 class="text-sm font-medium text-bodydark2">{{ Auth::user()->name }}</h5>
                    </div>
                    <ul class="flex flex-col overflow-y-auto border-t border-stroke dark:border-strokedark">
                        <li>
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button
                                    type="submit"
                                    class="flex w-full gap-3.5 px-4.5 py-3 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
                                    <svg
                                        class="fill-current"
                                        width="22"
                                        height="22"
