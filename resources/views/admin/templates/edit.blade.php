...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="h4 mb-0">Edit Message Template</h2>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('whatsapp_account_id') is-invalid @enderror" 
                                        ...
                                        @forelse($accounts as $account)
                                            <option value="{{ $account->id }}" {{ old('whatsapp_account_id', $template->whatsapp_account_id) == $account->id ? 'selected' : '' }}>
                                                {{ $account->name }}
                                            </option>
                                        @empty
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3" id="headerContentDiv" style="display: none;">
                            ...
                            <input type="text" 
                                   ...
                                   id="header_content" 
                                   name="header_content" 
                                   value="{{ old('header_content', $template->header_content) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('body_content') is-invalid @enderror" 
                                      ...
                                      name="body_content" 
                                      rows="5" 
                                      required>{{ old('body_content', $template->body_content) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="footer_content" 
                                   name="footer_content" 
                                   value="{{ old('footer_content', $template->footer_content) }}"
